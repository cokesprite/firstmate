...
| `fm-brief.sh`            | Scaffold ship (explicit `--mode`), scout, secondmate-charter, Herdr-lab, and PLAN execution briefs |
| `fm-plan-preflight.sh`   | PLAN dispatch preflight: contract lint, clean-worktree producer rehearsal evidence, and the mechanical producer-output amendment |
